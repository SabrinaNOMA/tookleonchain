...
try {
    ...
    if ($existingData) {
        ...
        $sql = "INSERT INTO token_sale_pages 
                    (project_id, sale_url, project_description_story, value_props_json, community_metrics_json, socials_json, team_json, partners_json, faqs_json, project_roadmap_json, video_file_path, whitepaper_file_path, general_images_json) 
                VALUES 
                    (:project_id, :sale_url, :project_description_story, :value_props_json, :community_metrics_json, :socials_json, :team_json, :partners_json, :faqs_json, :project_roadmap_json, :video_file_path, :whitepaper_file_path, :general_images_json)";
