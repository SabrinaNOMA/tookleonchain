...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $st->execute([':a'=>$applicantId, ':f'=>'SELFIE', ':t'=>($_POST['id_doc_type'] ?? null), ':p'=>($_POST['page'] ?? null), ':c'=>($_POST['country'] ?? null), ':n'=>$safe, ':p2'=>$path]);
  echo 'OK'; exit;
}
?>
<!doctype html><html><body>
  <h3>Manual upload (SELFIE) — placeholder</h3>
