...
<div class="p-8 md:p-12 max-w-4xl mx-auto">
    ...
    <form id="unifiedSaleForm" action="/backend/newsale_backend.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-8 flex flex-col sm:flex-row items-center justify-between">
            ...
            <button type="button" id="prefill-button" class="mt-3 sm:mt-0 flex items-center justify-center px-4 py-2 rounded-lg font-bold text-sm bg-purple-50 text-purple-700 hover:bg-purple-100 border border-purple-300 transition-colors shadow-sm">
                <i data-lucide="refresh-cw" class="w-4 h-4 mr-2"></i> Load Last Sale Data
            </button>
        </div>
